...
/* LogicalOrDecl */
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr p, A arg) { return visitDefault(p, arg); }
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.DeclIn p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(com.biosimilarity.GraphL.model.GraphL.Absyn.LogicalOrDecl p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
/* Satisfaction */
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement p, A arg) { return visitDefault(p, arg); }
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement p, A arg) { return visitDefault(p, arg); }
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(com.biosimilarity.GraphL.model.GraphL.Absyn.Satisfaction p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
/* Decl */
