...
public class PrettyPrinter
{
  ...
  public static String print(com.biosimilarity.GraphL.model.GraphL.Absyn.LogicalOrDecl foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(com.biosimilarity.GraphL.model.GraphL.Absyn.LogicalOrDecl foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(com.biosimilarity.GraphL.model.GraphL.Absyn.Satisfaction foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(com.biosimilarity.GraphL.model.GraphL.Absyn.Satisfaction foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(com.biosimilarity.GraphL.model.GraphL.Absyn.ListLogicalOrDecl foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(com.biosimilarity.GraphL.model.GraphL.Absyn.ListLogicalOrDecl foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.Comprehension foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.ComprehensionForm)
    {
       ...
       render("|");
       pp(_comprehensionform.listlogicalordecl_, 0);
       render("}");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.VertexComprehension foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.VertexComprehensionForm)
    {
       ...
       render("|");
       pp(_vertexcomprehensionform.listlogicalordecl_, 0);
       render("}");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeComprehension foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeComprehensionForm)
    {
       ...
       render("|");
       pp(_edgecomprehensionform.listlogicalordecl_, 0);
       render("}");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.GraphComprehension foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.GraphComprehensionForm)
    {
       ...
       render("|");
       pp(_graphcomprehensionform.listlogicalordecl_, 0);
       render("}");
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.LogicalOrDecl foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr _judgmentexpr = (com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_judgmentexpr.satisfaction_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.Satisfaction foo, int _i_)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement _vertexjudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_vertexjudgement.vertexdeconstructor_, 0);
       render("in");
       pp(_vertexjudgement.vertexstructurecondition_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement _edgejudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_edgejudgement.edgedeconstructor_, 0);
       render("in");
       pp(_edgejudgement.edgelabelcondition_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement _graphjudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_graphjudgement.graphdeconstructor_, 0);
       render("in");
       pp(_graphjudgement.condition_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  }
  ...
  private static void pp(com.biosimilarity.GraphL.model.GraphL.Absyn.ListLogicalOrDecl foo, int _i_)
  {
     for (java.util.Iterator<LogicalOrDecl> it = foo.iterator(); it.hasNext();)
     {
       pp(it.next(), 0);
       if (it.hasNext()) {
         render(",");
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.Comprehension foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.ComprehensionForm)
    {
       ...
       render("[");
       sh(_comprehensionform.listlogicalordecl_);
       render("]");
       render(")");
    }
  }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.VertexComprehension foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.VertexComprehensionForm)
    {
       ...
       render("[");
       sh(_vertexcomprehensionform.listlogicalordecl_);
       render("]");
       render(")");
    }
  }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeComprehension foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeComprehensionForm)
    {
       ...
       render("[");
       sh(_edgecomprehensionform.listlogicalordecl_);
       render("]");
       render(")");
    }
  }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.GraphComprehension foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.GraphComprehensionForm)
    {
       ...
       render("[");
       sh(_graphcomprehensionform.listlogicalordecl_);
       render("]");
       render(")");
    }
  }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.LogicalOrDecl foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr _judgmentexpr = (com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr) foo;
       render("(");
       render("JudgmentExpr");
       sh(_judgmentexpr.satisfaction_);
       render(")");
    }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.Satisfaction foo)
  {
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement _vertexjudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement) foo;
       render("(");
       render("VertexJudgement");
       sh(_vertexjudgement.vertexdeconstructor_);
       sh(_vertexjudgement.vertexstructurecondition_);
       render(")");
    }
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement _edgejudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.EdgeJudgement) foo;
       render("(");
       render("EdgeJudgement");
       sh(_edgejudgement.edgedeconstructor_);
       sh(_edgejudgement.edgelabelcondition_);
       render(")");
    }
    if (foo instanceof com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement)
    {
       com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement _graphjudgement = (com.biosimilarity.GraphL.model.GraphL.Absyn.GraphJudgement) foo;
       render("(");
       render("GraphJudgement");
       sh(_graphjudgement.graphdeconstructor_);
       sh(_graphjudgement.condition_);
       render(")");
    }
  }
  ...
  private static void sh(com.biosimilarity.GraphL.model.GraphL.Absyn.ListLogicalOrDecl foo)
  {
     for (java.util.Iterator<LogicalOrDecl> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
