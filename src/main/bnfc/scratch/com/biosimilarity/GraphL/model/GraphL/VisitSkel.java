...
public class VisitSkel
{
  ...
  public class LogicalOrDeclVisitor<R,A> implements LogicalOrDecl.Visitor<R,A>
  {
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.JudgmentExpr p, A arg)
    {
      /* Code For JudgmentExpr Goes Here */

      p.satisfaction_.accept(new SatisfactionVisitor<R,A>(), arg);
  ...
  public class SatisfactionVisitor<R,A> implements Satisfaction.Visitor<R,A>
  {
    public R visit(com.biosimilarity.GraphL.model.GraphL.Absyn.VertexJudgement p, A arg)
    {
      /* Code For VertexJudgement Goes Here */
    ...
    {
      /* Code For EdgeJudgement Goes Here */
    ...
    {
      /* Code For GraphJudgement Goes Here */
